...
export default async function UserProfile({
  ...
  const squads = (rawSquads || []).map((squad: any) => ({ // eslint-disable-line @typescript-eslint/no-explicit-any
    ...squad,
  ...
  const blueprintLikes = blueprints?.reduce((sum: number, item: any) => sum + (item.likes || 0), 0) || 0; // eslint-disable-line @typescript-eslint/no-explicit-any
  const squadLikes = squads.reduce((sum: number, item: any) => sum + (item.likes || 0), 0) || 0; // eslint-disable-line @typescript-eslint/no-explicit-any
          ...
          <section>
            ...
            {blueprints && blueprints.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {blueprints.map((blueprint: any) => ( // eslint-disable-line @typescript-eslint/no-explicit-any
          ...
          <section>
            ...
            {squads && squads.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {squads.map((squad: any) => ( // eslint-disable-line @typescript-eslint/no-explicit-any
                  <div key={squad.id}>
