    ...
    <>
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-[#FCEE21] text-black px-4 py-2 font-bold uppercase tracking-widest text-xs md:text-sm mb-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <span>{t('hero.construction_notice')}</span>
        </div>
        ...
        <FadeIn delay={0.4}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            >
              {t('features.interactive_map.title')}
            ...
            >
              {t('features.headhunt_simulator.title')}
            </Link>
          </div>
        </FadeIn>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/map" className="block group">
            <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#FCEE21] transition-all rounded-2xl p-8">
              ...
              <p className="text-zinc-600">
                {t('features.interactive_map.description')}
              </p>
            </div>
          </Link>
          ...
          <Link href="/headhunt" className="block group">
            <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#FCEE21] transition-all rounded-2xl p-8">
              ...
              <p className="text-zinc-600">
                {t('features.headhunt_simulator.description')}
              </p>
            </div>
          </Link>
          ...
          <Link href="/guides" className="block group">
            <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#FCEE21] transition-all rounded-2xl p-8">
              ...
              <h3 className="text-xl font-bold mb-2 text-black">
                {t('features.strategy_guides.title')}
              </h3>
              <p className="text-zinc-600">
                {t('features.strategy_guides.description')}
              </p>
            </div>
          </Link>
          ...
          <Link href="/blueprints" className="block group">
            <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#FCEE21] transition-all rounded-2xl p-8">
              ...
              <h3 className="text-xl font-bold mb-2 text-black">
                {t('features.automated_blueprints.title')}
              </h3>
              <p className="text-zinc-600">
                {t('features.automated_blueprints.description')}
              </p>
            </div>
          </Link>
          ...
          <Link href="/teams" className="block group">
            <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#FCEE21] transition-all rounded-2xl p-8">
              ...
              <h3 className="text-xl font-bold mb-2 text-black">
                {t('features.tactical_squads.title')}
              </h3>
              <p className="text-zinc-600">
                {t('features.tactical_squads.description')}
              </p>
            </div>
          </Link>
        </div>
