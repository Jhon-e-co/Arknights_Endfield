        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <FadeIn delay={0.1}>
            <Link href="/blueprints" className="block group">
              <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#FCEE21] transition-all">
                <div className="w-12 h-12 flex items-center justify-center bg-[#FCEE21] border border-black mb-4">
