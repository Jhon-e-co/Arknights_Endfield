  ...
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <FadeIn delay={0.1}>
            <Link href="/blueprints" className="block group">
              <div className="bg-zinc-900 border-2 border-zinc-800 rounded-lg p-6 hover:border-brand transition-all hover:shadow-[4px_4px_0px_0px_rgba(252,238,33,1)]">
    ...
    <section className="py-20 bg-zinc-900/50">
      <div className="container mx-auto px-4 text-center">
        ...
        <FadeIn delay={0.2}>
          <div className="bg-zinc-900 border-2 border-zinc-800 rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 bg-brand text-black px-6 py-3 rounded-md font-bold hover:bg-brand-hover transition-colors"
            >
